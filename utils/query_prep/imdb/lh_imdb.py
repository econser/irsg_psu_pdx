...
class LeadingHorse(imdb):
    def __init__(self, image_set, devkit_path):
        imdb.__init__(self, image_set)
        self._image_set = image_set
        self._devkit_path = devkit_path
        self._data_path = os.path.join(self._devkit_path, 'data')
        self._classes = ('__background__', 'horse-leader', 'horse', 'lead')
    ...
    def image_path_from_index(self, index):
        ...
        for ext in self._image_ext:
            image_path = os.path.join(self._data_path, 'LeadingHorse',
                                      'LeadingHorse{}{}'.format(index, ext))
    ...
    def get_classes_from_anno(self, anno_names):
        ...
        for anno_name in anno_names:
            if anno_name.startswith('horse-leader'):
                objects.append('horse-leader')
            elif anno_name.startswith('horse-'):
                objects.append('horse')
            elif anno_name.startswith('lead'):
                objects.append('lead')
            else:
    ...
    def _load_annotation(self, index):
        ...
        filename = os.path.join(self._data_path, 'LeadingHorse', 'LeadingHorse{}{}'.format(index) + '.labl')
        f = open(filename, 'rb')
        lines = f.readlines()
        annotation = lines[0]
...
# Evaluation -------------------------------------------------------------------
    def _do_python_eval(self, output_dir = 'output'):
        ...
        imagesetfile = os.path.join(
            self._data_path,
            'leadinghorse_fnames' + self._image_set + '.txt')
