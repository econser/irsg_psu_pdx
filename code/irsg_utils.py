# Original IRSG primary structure
...
# IRSG_situation primary structure
...
class RelationshipParameters (object):
    def __init__(self, platt_a, platt_b, gmm_weights, gmm_mu, gmm_sigma, gmm=None):
        ...
        self.model = gmm # a scipy.stats.multivariate_normal object
...
def get_dw_boxes(annotation):
    ...
    #return obj_dict['dog_walker'], obj_dict['dog'], obj_dict['leash']
    return obj_dict
