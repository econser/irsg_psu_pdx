...
if __name__ == '__main__':
    ...
    if mode == 'precalc':
        ...
        rc_list = get_boxes_and_scores(image_dir, model_file, weights, class_list, gmms, cpu_flag, nms_threshold=1.0, imageset=imageset)
    ...
    for rc in rc_list:
        ...
        # generate factor graph and run inference
            ...
            energy, best_box_ixs = get_geo_mean_energy(rc, [2, 1, 1])
