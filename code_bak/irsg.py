...
"""
    get_gmm_features
    expects [x_min, y_min, x_max, y_max]

def get_gmm_features(box_pairs):
    subj_axis = 0
    obj_axis = 1
    ...
    features = np.vstack((relative_x_centers, relative_y_centers, relative_heights, relative_widths))
    features = features.T
